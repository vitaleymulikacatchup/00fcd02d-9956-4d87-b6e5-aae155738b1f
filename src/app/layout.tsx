...
export const metadata: Metadata = {
  title: "Luxe Haven Hotel - Luxury Accommodation & World-Class Service",
  description: "Experience luxury at Luxe Haven Hotel. Book luxurious rooms, spa services, fine dining, and unforgettable stays in a premium setting.",
  keywords: "luxury hotel, accommodation, resort, spa, fine dining, business travel",
  metadataBase: new URL("https://luxehaven-hotel.com"),
  alternates: {
    canonical: "https://luxehaven-hotel.com"
  },
  openGraph: {
    title: "Luxe Haven Hotel - Premium Luxury Accommodation",
    description: "Discover unparalleled comfort and luxury at Luxe Haven Hotel. Award-winning service and exquisite amenities await.",
    url: "https://luxehaven-hotel.com",
    siteName: "Luxe Haven Hotel",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SAuZG11YN2jMHmu0FsR9Di3IL/uploaded-1764016558360-ny5tvni2.jpg",
      alt: "Luxe Haven Hotel luxury room"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Luxe Haven Hotel - Luxury Stays & Premium Service",
    description: "Experience world-class hospitality at Luxe Haven Hotel. Book your perfect getaway today.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SAuZG11YN2jMHmu0FsR9Di3IL/uploaded-1764016558360-ny5tvni2.jpg"]
  },
  robots: {
    index: true,
    follow: true
